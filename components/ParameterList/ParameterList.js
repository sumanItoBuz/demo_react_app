                    ...
                    if(this.state.isLoading){
                        ...
                        return <div id="parameter_list">
                            ...
                            <table>
                                ...
                                <tbody>
                                    {(()=>{
                                        if(this.state.parameters_list instanceof Array){
                                            return this.state.parameters_list.map((parameter, index)=>{
                                                return <tr key={parameter.key}>
                                                    <td>{index}</td>
                                                    <td>{parameter.name}</td>
                                                    <td>{parameter.key}</td>
                                                    <td dangerouslySetInnerHTML={{ __html: parameter.symbol }}></td>
                                                    <td>{parameter.unit}</td>
                                                    <td>{(parameter.thresholds.upper_limit)? parameter.thresholds.upper_limit : 0} -  {(parameter.thresholds.lower_limit)? parameter.thresholds.lower_limit : 0}</td>
                                                    <td>
                                                        <button className="configure" onClick={()=>this.configureParameter(parameter.key)}>
                                                        <svg version="1.1" id="Capa_1" height="25" width="25" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 439.832 439.832" style={{enableBackground: 'new 0 0 439.832 439.832'}} xmlSpace="preserve">
                                                            <g>
                                                                <g>
                                                                <path style={{fill: 'var(--dark)'}} d="M225.36,259.98h-22.48c-1.417-4.285-3.155-8.457-5.2-12.48l16-16c3.102-3.12,3.102-8.16,0-11.28l-28.8-28.8
                                                            ...
                                                            <g>
                                                                <g>
                                                                <path style={{fill: 'var(--dark)'}} d="M116.8,243.981c-24.742,0-44.8,20.058-44.8,44.8s20.058,44.8,44.8,44.8c24.742,0,44.8-20.058,44.8-44.8
                                                            ...
                                                            <g>
                                                                <g>
                                                                <path style={{fill: 'var(--dark)'}} d="M439.683,148.359c-0.025-0.127-0.052-0.253-0.083-0.378l-8.64-39.44c-0.956-4.304-5.214-7.023-9.52-6.08l-21.92,4.8
                                                            ...
                                                            <g>
                                                                <g>
                                                                <path style={{fill: 'var(--dark)'}} d="M365.2,143.741c-4.422-20.62-22.671-35.333-43.76-35.28c-24.742-0.009-44.807,20.041-44.817,44.783
